...
const validadekey = JSON.parse(fs.readFileSync('./armor/validadekey.json'));

const geradorkey = JSON.parse(fs.readFileSync('./armor/geradorkey.json'));
...
const simih = async (text) => {
	try {
const sami = await fetch(`https://simsimi.info/api/?text=${text}&lc=pt`, {method: 'GET'})
